...
parch = st.number_input("Parents/Children Abroad (Parch)", min_value=0, max_value=10, value=0, step=1)
fare = st.number_input("Fare", min_value=0.0, max_value=600.0, value=32.0, step=1.0)
embarked = st.selectbox("Port of Embarkation", ["C", "Q", "S"])

if st.button("Predicted Survival"):
    input_data={
        "Pclass": pclass,
        "Sex": sex,
        "Age": age,
    ...
    if prediction==1:
        ...
        st.error("Prediction: Passanger would likely **Not Survive**")
